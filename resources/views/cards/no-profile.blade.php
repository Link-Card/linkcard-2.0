...
<body class="min-h-screen flex items-center justify-center" style="background-color: #F7F8F4;">
    <div class="max-w-md mx-auto px-6 text-center">
        ...
        {{-- Icône --}}
        <div class="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center" style="background-color: #EFF6FF;">
            <svg class="w-10 h-10" style="color: #4A7FBF;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
        </div>

        <h1 class="text-2xl font-semibold mb-3" style="color: #2C2A27;">Aucun profil lié</h1>
        <p class="text-base mb-8" style="color: #4B5563;">
            Cette carte est activée mais n'est liée à aucun profil. Le propriétaire doit configurer un profil dans son tableau de bord.
        </p>
