...
<body style="font-family: 'Manrope', sans-serif; background-color: #F7F8F4;" class="min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        ...
        <h1 class="text-2xl font-semibold mb-2" style="color: #2C2A27;">Aucun profil lié</h1>
        <p class="mb-6" style="color: #4B5563;">Cette carte est active mais n'est liée à aucun profil pour le moment.</p>
