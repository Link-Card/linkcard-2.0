        ...
        <aside class="w-64 bg-indigo-800 text-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="{{ route('cards.index') }}"
                   class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('cards.*') ? 'bg-indigo-900 text-white' : 'text-indigo-100 hover:bg-indigo-700' }} transition">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-indigo-700 p-4">
                <div class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-indigo-700 transition">
