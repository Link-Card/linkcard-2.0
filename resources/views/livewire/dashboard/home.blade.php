<div class="py-6 sm:py-8">
    ...
    {{-- ═══════════════════════════════════════ --}}
    {{-- WELCOME MODAL — Single slide, starts tour --}}
    {{-- ═══════════════════════════════════════ --}}
        ...
        <div class="bg-white rounded-2xl w-full max-w-sm overflow-hidden relative"
            ...
            <div class="pt-10 pb-6 px-8 text-center">
                ...
                <p class="text-sm leading-relaxed mb-8" style="font-family: 'Manrope', sans-serif; color: #4B5563;">
                    On vous fait un <strong>petit tour rapide</strong> des fonctionnalités. Ça prend 30 secondes!
                </p>

                <div class="space-y-3">
                    <button wire:click="startTour" class="w-full py-3 px-6 rounded-xl text-white font-medium text-sm transition-all duration-200" style="font-family: 'Manrope', sans-serif; background: #42B574;" onmouseover="this.style.background='#3DA367'" onmouseout="this.style.background='#42B574'">
                        Commencer le tour →
                    </button>
                    <button @click="show = false; $wire.closeModal()" class="w-full py-2.5 px-6 rounded-xl font-medium text-sm transition-all duration-200" style="font-family: 'Manrope', sans-serif; color: #9CA3AF;" onmouseover="this.style.color='#4B5563'" onmouseout="this.style.color='#9CA3AF'">
                        Plus tard
                    </button>
                </div>
            </div>
