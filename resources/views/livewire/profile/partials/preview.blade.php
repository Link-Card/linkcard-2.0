<div class="sticky top-6">
    ...
    <div class="rounded-2xl overflow-hidden" style="box-shadow: 0 8px 32px rgba(0,0,0,0.12); border: 1px solid #E5E7EB;">
        ...
        <div class="overflow-y-auto" style="max-height: calc(100vh - 120px); background: {{ $previewBodyBg }};">
            ...
            @php
                // Bridge wrapper - headers have their own gradient, transition has containerBg
                $previewBridgeGradient = 'background: transparent';
            @endphp
            ...
            @elseif($headerStyle === 'split')
                <div class="relative" style="background: linear-gradient(135deg, {{ $primary_color }} 0%, {{ $secondary_color }} 100%); overflow: hidden;">
            ...
            @elseif($headerStyle === 'geometric')
                <div class="relative" style="background: linear-gradient(135deg, {{ $primary_color }}, {{ $secondary_color }}); overflow: hidden;">
