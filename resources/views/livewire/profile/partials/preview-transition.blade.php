...
@if($transition === 'wave')
    <div style="margin-bottom: -2px; line-height: 0;">
        <svg viewBox="0 0 400 30" style="display: block; width: 100%;" preserveAspectRatio="none">
            <path d="M0,15 C50,0 100,25 200,12 C300,0 350,20 400,10 L400,30 L0,30 Z" fill="{{ $fillColor }}80" />
...
@elseif($transition === 'double_wave')
    <div style="margin-bottom: -2px; line-height: 0;">
        <svg viewBox="0 0 400 40" style="display: block; width: 100%;" preserveAspectRatio="none">
            <path d="M0,20 C50,5 100,30 200,15 C300,2 350,25 400,12 L400,40 L0,40 Z" fill="{{ $fillColor }}60" />
            <path d="M0,25 C60,10 130,32 220,18 C310,5 370,28 400,20 L400,40 L0,40 Z" fill="{{ $fillColor }}90" />
