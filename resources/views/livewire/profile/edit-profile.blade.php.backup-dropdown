        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            @elseif($activeTab === 'contenu')
                ...
                <div class="space-y-6">
                    ...
                    <!-- Preview du profil -->
                    <div class="max-w-md mx-auto border-2 border-dashed border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <div class="bg-white px-6 pb-6 space-y-4">
                            ...
                            <!-- UN SEUL bouton + à la fin -->
                            <div class="pt-4">
                                <div class="relative inline-block w-full">
                                    <button @click="show = !show"
                                        x-data="{ show: false }"
                                        @click.away="show = false"
                                        class="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-indigo-500 hover:text-indigo-600 transition font-medium">
                                        ➕ Ajouter une bande
                                    </button>
                                    ...
                                    <div x-data="{ open: false }" class="relative">
                                        ...
                                        <div x-show="open" 
                                            ...
                                            @if($availableTypes['social_link']['available'])
                                                <button wire:click="openAddBandModal('social_link')"
                                            ...
                                            @if($availableTypes['image']['available'])
                                                <button wire:click="openAddBandModal('image')"
                                                    class="w-full text-left px-4 py-3 hover:bg-gray-50 flex items-center justify-between border-b">
                                                    <div class="flex items-center space-x-3">
                                            ...
                                            @if($availableTypes['contact_button']['available'])
                                                <button wire:click="openAddBandModal('contact_button')"
                                                    class="w-full text-left px-4 py-3 hover:bg-gray-50 flex items-center justify-between border-b">
                                                    <div class="flex items-center space-x-3">
                                                        <span class="text-2xl">☎️</span>
                                            ...
                                            @if($availableTypes['text_block']['available'])
                                                <button wire:click="openAddBandModal('text_block')"
                ...
                @if($newBandType === 'text_block')
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea wire:model="newTextContent" rows="6" maxlength="500"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg"></textarea>
                            <p class="text-sm text-gray-500 mt-1">{{ strlen($newTextContent ?? '') }}/500 caractères</p>
