                ...
                <div class="bg-white rounded-xl shadow-sm border-2 transition-all {{ $currentPlan === $key ? 'border-[#42B574]' : 'border-transparent hover:border-[#D1D5DB]' }}">
                    ...
                    <div class="p-6 border-b border-[#E5E7EB]">
                        ...
                        <div class="flex items-baseline">
                            ...
                            <span class="text-[#4B5563] ml-1" style="font-family: 'Manrope', sans-serif;">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            @if($currentPlan === $key)
                                <button disabled class="w-full py-2 px-4 bg-[#E5E7EB] text-[#9CA3AF] rounded-lg font-medium cursor-not-allowed" style="font-family: 'Manrope', sans-serif;">
                                    Plan actuel
                                </button>
                            @elseif($isSubscribed)
                                {{-- Déjà abonné: rediriger vers portail --}}
                                ...
                                @else
                                    <button
                                        wire:click="redirectToPortal"
                                        class="w-full py-2 px-4 border border-[#F59E0B] text-[#D97706] rounded-lg font-medium hover:bg-[#FEF3C7] transition-colors"
                                        style="font-family: 'Manrope', sans-serif;"
                                    >
                            ...
                            @elseif($key !== 'free')
                                ...
                                <button
                                    ...
                                    class="w-full py-2 px-4 bg-[#42B574] text-white rounded-lg font-medium hover:bg-[#3DA367] transition-colors disabled:opacity-50"
                                    style="font-family: 'Manrope', sans-serif;"
                                >
                                    <span wire:loading.remove wire:target="subscribe">Commencer</span>
                                    <span wire:loading wire:target="subscribe">Chargement...</span>
                                </button>
                            @endif
                        </div>
                    </div>
